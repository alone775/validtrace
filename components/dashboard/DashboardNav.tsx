  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-white border-b border-slate-200 z-40 flex items-center px-4 justify-between">
        <div className="font-bold text-xl text-slate-900">ValidTrace</div>
        <button
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-200 transform transition-transform duration-200 ease-in-out lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'
        }`}>
        <div className="flex flex-col h-full">
          ...
          {/* Mobile Menu Header inside Sidebar (optional, for consistency if needed) */}
          <div className="p-4 border-b border-slate-200 lg:hidden flex justify-between items-center">
